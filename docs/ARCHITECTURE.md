...
- `gimbal.moveto()` รับ yaw เทียบตำแหน่งตอนเปิดเครื่อง แต่ `sub_angle` ส่งทั้ง yaw เทียบ chassis และ yaw เทียบตอนเปิดเครื่อง DFS แปลงเป้าหมายจากกรอบ chassis ไปเป็นคำสั่งกรอบตอนเปิดเครื่อง และเลือกมุมสมมูลในช่วง SDK `[-250°,250°]` ที่ใกล้ตำแหน่งปัจจุบันสุด โดยยังตรวจมุม scan ในกรอบ chassis ก่อนอนุญาตให้เดิน
