...
- DFS ตรวจทางในแผนที่ด้วย `robot_radius_m + clearance_margin_m` หลังสแกนครบสี่ทิศ หากยังไม่ได้เดินและไม่มีทิศปลอดภัยจะแสดงสถานะ `no_safe_direction` พร้อมเหตุผลบน dashboard แทน `completed`; ห้ามลดรัศมีหรือ margin เพียงเพื่อบังคับให้เดินก่อนสอบเทียบตำแหน่งหัว ToF และขนาดหุ่นจริง
