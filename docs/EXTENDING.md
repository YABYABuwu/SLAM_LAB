...
ก่อนปรับการควบคุม gimbal ให้จำกรณีรัน `20260925_214708_411803`: yaw และ ToF ตรงทิศแล้ว แต่ `recenter()` ไม่รายงานว่าจบภายในเวลา; pitch ยังคลาดจากศูนย์และข้อมูลที่บันทึกไม่พอชี้ชัดว่าแกน pitch ติดหรือ completion push ของ SDK หาย ต้องออกแบบงบเวลาเคลื่อนที่, รอ action จบ และรอ scan แยกกันตามระยะหมุนจริงและพฤติกรรม SDK ตรวจและบันทึก action state/percent พร้อม pitch และ yaw ตอน timeout เพื่อวิเคราะห์ต้นเหตุ ทดสอบ action ที่จบช้า, ค้าง, ล้มเหลว และข้อมูล scan ที่มาก่อน action จบ ทั้งหมดต้องไม่อนุญาตให้เดินหรือสั่ง gimbal action ใหม่จน action เดิมจบอย่างถูกต้อง; แสดงเหตุหยุดใน dashboard และ run review ผ่านสถานะ/summary เดิม
