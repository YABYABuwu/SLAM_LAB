...
การตรวจทางในแผนที่ใช้รัศมีหุ่น `robot_radius_m` รวม `clearance_margin_m`; หากไม่มีทิศที่ผ่านตั้งแต่จุดเริ่ม DFS รายงาน `no_safe_direction` บน dashboard และใน run summary/review แทนการรายงานว่าเดินสำรวจเสร็จแล้ว ค่า `pivot_x_m`/`pivot_y_m` ต้องวัดจากจุดกึ่งกลางตัวหุ่นถึงแกน yaw ของ gimbal จริงก่อนตีความระยะข้างหุ่น ห้ามลดรัศมีหรือ margin จากผลแผนที่อย่างเดียวเพื่อบังคับให้หุ่นเดิน
